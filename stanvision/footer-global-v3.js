...
$('[mode="light"]').hover(
  function() { // mouseenter
    $('.cursor-line-one, .cursor-line-two').addClass('bg-black');
  },
  function() { // mouseleave
    $('.cursor-line-one, .cursor-line-two').removeClass('bg-black');
  }
);

$('[mode="dark"]').hover(
  function() { // mouseenter
    $('.cursor-line-one, .cursor-line-two').addClass('bg-white');
  },
  function() { // mouseleave
    $('.cursor-line-one, .cursor-line-two').removeClass('bg-white');
  }
);
