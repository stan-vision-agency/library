...
//On hover White backgrounds - change color of cursor
$('[mode="light"]').on('mouseenter', function() {
  $('.cursor-line-one').addClass('bg-black');
});
$('[mode="light"]').on('mouseenter', function() {
  $('.cursor-line-two').addClass('bg-black');
});

$('[mode="light"]').on('mouseleave', function() {
  $('.cursor-line-one').removeClass('bg-black');
});
$('[mode="light"]').on('mouseleave', function() {
  $('.cursor-line-two').removeClass('bg-black');
});

//On hover Dark backgrounds - change color of cursor
$('[mode="dark"]').on('mouseenter', function() {
  $('.cursor-line-one').addClass('bg-white');
});
$('[mode="dark"]').on('mouseenter', function() {
  $('.cursor-line-two').addClass('bg-white');
});

$('[mode="dark"]').on('mouseleave', function() {
  $('.cursor-line-one').removeClass('bg-white');
});
$('[mode="dark"]').on('mouseleave', function() {
  $('.cursor-line-two').removeClass('bg-white');
});
